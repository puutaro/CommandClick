...
//    ) as String
    ...
    private const val cmdValSectionStart =  CommandClickScriptVariable.CMD_SEC_START
    private const val cmdValSectionEnd =  CommandClickScriptVariable.CMD_SEC_END
