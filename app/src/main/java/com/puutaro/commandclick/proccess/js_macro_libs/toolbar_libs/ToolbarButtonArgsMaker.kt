...
//                    |${iconKey}=folda
//                    |${jsPathKey}=${MacroForToolbarButton.Macro.JS_IMPORT.name}
//                    |${parentMenuKey}=manage,
//                ${menuNameKey}=add
//                    |${iconKey}=plus
//                    |${jsPathKey}=${MacroForToolbarButton.Macro.ADD.name}
//                    |${parentMenuKey}=manage,
//        ${menuNameKey}=setting
//            |${iconKey}=setting,
//                ${menuNameKey}=app dir manager
//                    |${iconKey}=setting
//                    |${jsPathKey}=${MacroForToolbarButton.Macro.APP_DIR_MANAGER.name}
