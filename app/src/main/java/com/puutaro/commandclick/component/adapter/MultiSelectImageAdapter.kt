...
class MultiSelectImageAdapter(
    ...
    override fun getView(
        ...
        if (convertViewArg == null) {
            ...
            val textView = convertView.findViewById<TextView>(com.puutaro.commandclick.R.id.grid_caption_view)
            textView.text = imageName
            holder = ViewHolder()
            holder.textView = textView
            val imageView = convertView.findViewById<ImageView>(com.puutaro.commandclick.R.id.grid_image_view)
