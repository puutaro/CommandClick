...
//
//
//    fun executeProotCommandCmdOnly(
//        command: String,
...
//
//        val updatedCommand = busyboxWrapper.addBusyboxAndProotCmdOnly(command)
...
//    }
//
//    fun addBusyboxAndProotCmdOnly(command: String): List<String> {
//        return listOf(ulaFiles.busybox.absolutePath, "sh", "support/execInProotCmdOnly.sh") + command.split(" ")
//    }
//
//    fun getProotEnv(
//        filesystemDir: File,
