...
object AssetsFileManager {
    ...
    const val confirmDialogDirPath = "${resPngDirPath}/confirm_dialog"
    const val xPngPath = "${confirmDialogDirPath}/x150.png"
    const val oPngPath = "${confirmDialogDirPath}/o150.png"
