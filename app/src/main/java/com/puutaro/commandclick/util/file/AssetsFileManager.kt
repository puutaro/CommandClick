...
object AssetsFileManager {
    ...
    const val fannelManagerPath = "${resPngDirPath}/fannel_manager.png"
    const val searchPingPath = "${resPngDirPath}/search.png"
    const val settingPingPath = "${resPngDirPath}/setting.png"
    const val urlHistoryPingPath = "${resPngDirPath}/url_history.png"
    const val downPingPath = "${resPngDirPath}/down.png"
    const val topPingPath = "${resPngDirPath}/top.png"
