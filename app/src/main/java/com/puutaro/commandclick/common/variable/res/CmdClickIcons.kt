...
enum class CmdClickIcons(
    ...
    LONG_PRESS("long_press", R.drawable.long_press),
    MAIL("mail", R.drawable.icons8_mail),
    MINUS("minus", R.drawable.minus),
    ...
    PIN("pin", R.drawable.pin),
    PIN_LOCATION("pin_location", R.drawable.pin_location),
