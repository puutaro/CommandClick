...
//    val cmdclickConfigFilePath = "$cmdclickDefaultAppDirPath/$cmdclickConfigFileName"
    ...
    val fannelSettingVariablsDirPath = "${cmdclickDefaultAppDirPath}/\${001}/${settingVariablesDirName}"
    ...
    private val fannelLogoDirPath = "${fannelSettingImagesDirPath}/${fannelLogoDirName}"
    private const val fannelLogoPngName = "logo.png"
    val fannelLogoPngPath = "${fannelLogoDirPath}/${fannelLogoPngName}"
    ...
    private const val cmdclickFannelSystemDirName = "fannel"
    const val cmdclickFannelSystemDirRelativePath = "$cmdclickSystemDirName/$cmdclickFannelSystemDirName"
    val cmdclickFannelSystemDirPath = "${cmdclickDefaultAppDirPath}/${cmdclickFannelSystemDirRelativePath}"
    val fannelSettingMapTsvName = "settingMap.tsv"
    val fannelSettingMapTsvPath = "${cmdclickFannelSystemDirPath}/${fannelSettingMapTsvName}"
    val pinFannelTsvName = "pinFannel.tsv"
    val pinFannelTsvPath = "${cmdclickFannelSystemDirPath}/${pinFannelTsvName}"
    val preInstallFannelListTsvName = "preInstallFannelList.tsv"
    val preInstallFannelListTsvPath = "${cmdclickFannelSystemDirPath}/${preInstallFannelListTsvName}"
    ...
    val cmdclickTempSystemDirPath = "${cmdclickDefaultAppDirPath}/${cmdclickTempSystemDirRelativePath}"
    private const val cmdclickUpdateFannelInfoSystemDirName = "updateFannelInfo"
    val cmdclickUpdateFannelInfoSystemDirPath = "$cmdclickTempSystemDirPath/$cmdclickUpdateFannelInfoSystemDirName"
    ...
    val longPressMenuDirPath = "${cmdclickDefaultAppDirPath}/\${001}/longPressMenuDir"
    ...
    val selectMenuFannelPath = "${cmdclickDefaultAppDirPath}/selectMenu$JS_FILE_SUFFIX"
