...
object UsePath {
    ...
    const val execJsAcDebugName = "jsAcDebug.txt"
    private const val jsAcDebugRelativePath = "${cmdclickTempDebugRelativeDirPath}/${execJsAcDebugName}"
    val jsAcDebugReportPath = "${rootPath}/${jsAcDebugRelativePath}"
