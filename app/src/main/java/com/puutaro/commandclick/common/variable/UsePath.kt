...
class UsePath {
    companion object {
        ...
        const val cmdclickTextToSpeechTrackFileName = "track.txt"
        private const val cmdclickTextToSpeechTrackRelativePath = "$cmdclickTempTextToSpeechRelativeDirPath/$cmdclickTextToSpeechTrackFileName"
        val cmdclickTextToSpeechTrackFilePath =  "$rootPath/$cmdclickTextToSpeechTrackRelativePath"
