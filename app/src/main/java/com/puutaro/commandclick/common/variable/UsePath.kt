...
class UsePath {
    companion object {
        ...
        private const val cmdclickConfigDirName = "AppConfigDir"
        private const val cmdclickConfigDirRelativePath = "$cmdclickConfRelativePath/$cmdclickConfigDirName"
        val cmdclickConfigDirPath =  "$rootPath/$cmdclickConfigDirRelativePath"
        val cmdclickConfigFileName = "cmdclickConfig${CommandClickShellScript.JS_FILE_SUFFIX}"
        val cmdclickButtonExecShellFileName = "cmdclickButtonExec${CommandClickShellScript.JS_FILE_SUFFIX}"
        val cmdclickInternetButtonExecJsFileName = "internetButtonExec${CommandClickShellScript.JS_FILE_SUFFIX}"
        private val cmdclickConfigFileRelativePath = "$cmdclickConfigDirRelativePath/$cmdclickConfigFileName"
