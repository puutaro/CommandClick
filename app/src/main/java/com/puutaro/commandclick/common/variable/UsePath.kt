...
class UsePath {
    companion object {
        ...
        const val cmdclickScrollPosiFileName = "scrollPosi"
        private const val cmdclickScrollPosiRelativePath = "$cmdclickTextHtmlRelativeDirPath/$cmdclickScrollPosiFileName"
        val cmdclickScrollPosiFilePath =  "$rootPath/$cmdclickScrollPosiRelativePath"
