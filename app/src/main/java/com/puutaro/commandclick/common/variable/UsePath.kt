...
class UsePath {
    companion object {
        ...
        val cmdclickSystemDirName = "system"
        val cmdclickUrlSystemDirName = "url"
        val cmdclickUrlSystemDirRelativePath = "${cmdclickSystemDirName}/${cmdclickUrlSystemDirName}"
        val cmdclickUrlHistoryFileName = "cmdclickUrlHistory"
        val cmdclickStartupJsName = "cmdclick_startup.js"
